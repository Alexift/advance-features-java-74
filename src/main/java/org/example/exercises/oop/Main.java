 ...
 *          - clasa parinte MultimediaItem ( instantioaza cele 2 metode generice play/Stop )
 ...
 *     Create concrete classes Audio and Video that extend the MultimediaItem class and implement their specific methods for playing and stopping.
 */
public class Main {
